...
import { ClipboardCheck, User, Lock, Smile } from 'lucide-react'
      ...
      <Card className="w-full max-w-sm">
        <CardContent className="pt-8 pb-6">
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-semibold text-zinc-950">创建账号</h1>
            <p className="text-sm text-zinc-500 mt-1">注册 PlanFlow AI 账号开始使用</p>
          </div>
          ...
          <div className="mt-5 text-center text-sm text-zinc-500">
            已有账号？
            <Link to="/login" className="ml-1.5 text-zinc-950 font-medium hover:text-zinc-700 transition-colors">
              立即登录
            </Link>
          </div>
        </CardContent>
