...
| **P1** | 基础工程搭建 | 2 天 | ⏳ 待开始 |
| **P2** | 输入源与文件上传 | 1 天 | ⏳ 待开始 |
| **P3** | OCR 与文档解析 | 2 天 | ⏳ 待开始 |
| **P4** | AI 解析与结构化落库 | 2 天 | ⏳ 待开始 |
| **P5** | 前端核心页面 | 2 天 | ⏳ 待开始 |
| **P6** | 通知能力 | 1 天 | ⏳ 待开始 |
| **P7** | 完善与答辩准备 | 2 天 | ⏳ 待开始 |
